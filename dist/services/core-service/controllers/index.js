...
const redisBroadcastRepository = new RedisBroadcastRepository_1.RedisBroadcastRepository();
const sendBroadcastUseCase = new SendBroadcastUseCase_1.SendBroadcastUseCase(redisBroadcastRepository);
exports.broadcastController = new BroadcastController_1.BroadcastController(sendBroadcastUseCase);
// Group Controller Setup
const groupRepository = new PostgresGroupRepository_1.PostgresGroupRepository();
const createGroupUseCase = new CreateGroupUseCase_1.CreateGroupUseCase(groupRepository);
const deleteGroupUseCase = new DeleteGroupUseCase_1.DeleteGroupUseCase(groupRepository);
exports.groupController = new GroupController_1.GroupController(createGroupUseCase, deleteGroupUseCase, groupRepository);
