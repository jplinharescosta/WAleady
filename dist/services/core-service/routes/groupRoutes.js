...
router.post("/", (req, res) =>
  controllers_1.groupController.createGroup(req, res),
);
router.get("/", validadePagination_1.validatePagination, (req, res) => {
  controllers_1.groupController.getGroups(req, res);
});
router.get("/:id", validadeIdParam_1.validateIdParam, (req, res) =>
  controllers_1.groupController.getGroupById(req, res),
);
router.delete("/:id", validadeIdParam_1.validateIdParam, (req, res) =>
  controllers_1.groupController.deleteGroup(req, res),
);
